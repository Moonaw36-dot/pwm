...
- [x] **Corrupt config silently resets to defaults** — `config.rs:34` at minimum log the error instead of silently unwrapping.
...
- [x] **Light theme toggle** — switchable light mode alongside the existing dark theme.
